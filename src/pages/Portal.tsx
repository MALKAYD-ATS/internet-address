...
const Portal: React.FC = () => {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      // Update email and password in auth if changed
      if (editProfileData.email !== user.email || editProfileData.password) {
        const updates: any = {};
      ...
      // Update profile in students table
      const { error: profileError } = await supabase
        .from('students')
        .update({
          full_name: editProfileData.full_name,
          phone_number: editProfileData.phone_number,
          profile_image: editProfileData.profile_image
        })
        .eq('id', user.id);
          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 text-xs sm:text-base">Welcome back!</p>
              </div>
            </div>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
          <div className={`p-4 rounded-lg border ${
            ...
            <div className="flex items-center">
              ...
              <span className="font-medium">{profileUpdateMessage.text}</span>
            </div>
          </div>
        </div>
      )}
                ...
                {!isEditingProfile ? (
                  <div className="space-y-4">
                    ...
                    <button 
                      ...
                      className="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        type="url"
                        name="profile_image"
                        value={editProfileData.profile_image}
                        onChange={handleProfileInputChange}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div className="flex gap-3 mt-6">
                      ...
                      <button
                        ...
                        disabled={isUpdatingProfile}
                        className="flex-1 py-2 px-4 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg font-medium transition-colors duration-200"
                      >
                        Cancel
                      </button>
                    </div>
