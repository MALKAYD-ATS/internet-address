                ...
                {enrolledCourses.length > 0 ? (
                  <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
                    {enrolledCourses.map((course) => (
                      <div key={course.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow min-w-0 w-full">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm gap-2 w-full">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 w-full">
                      ...
                      <span className="text-gray-900 font-mono bg-gray-50 px-3 py-2 rounded border break-all min-w-0 w-full sm:flex-1">
                        {profile.id}
                      </span>
