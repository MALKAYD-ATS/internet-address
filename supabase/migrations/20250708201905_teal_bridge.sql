...
-- Home Page Title Section
INSERT INTO home_page_title_section (name, text, slogan, video) VALUES
('Professional Drone Academy', 'Advocate, Encourage, and Unite Indigenous Peoples & Communities to lead the Drone Industry.', 'Training for the Future', 'https://nnhgbtrkxepkeotpdnxw.supabase.co/storage/v1/object/public/media-assets/videos/building-future-workforce.mp4');

-- Home Numbers
INSERT INTO home_numbers (number, label, order_index) VALUES
...
-- Choose ATS
INSERT INTO choose_ats (symbol, name, text, order_index) VALUES
...
-- Drone Solutions
INSERT INTO drone_solutions (symbol, text, order_index) VALUES
...
-- Principles (Vision & Mission)
INSERT INTO principles (symbol, title, text, order_index) VALUES
...
-- Heading (Where We Are Heading)
INSERT INTO heading (symbol, title, text, video, order_index) VALUES
...
-- Ventures
INSERT INTO ventures (logo_url, name, relationship, text, video_url, order_index) VALUES
...
-- Contact Information
INSERT INTO contact_information (phone, email) VALUES
('+1 (587) 524-0275', 'darcy@abtraining.ca');
...
-- Student Success Stories
INSERT INTO student_success_stories (photo_url, name, position, company, rating, text, order_index) VALUES
